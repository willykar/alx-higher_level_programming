#!/usr/bin/python3
""" Defines unittests for the square.py module"""
...
class TestSquare_instance(unittest.TestCase):
    """Class for testing instantiation of the class Square"""

    def test_is_base(self):
        """checks if the first arg is an istance of the second arg"""
        self.assertIsInstance(Square(25), Base)
...
class TestSquare_x(unittest.TestCase):
    """Unittests for testing initialization of the Square "x" attribute"""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for testing initialization of the Square "y" attribute"""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests for testing order of the Square attribute initialization"""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests for testing __str__ and display methods of the Square class"""
    ...
    def capture_stdout(sq, method):
        ...
        Returns:
            The text printed to stdout by calling method on square
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittests for testing the update(kwargs) method"""
